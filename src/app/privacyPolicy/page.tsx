            ...
            <main className="main text-left">
                <div className="custom">
                    <div className="mx-auto mb-4 max-w-6xl">
                        <h2 className="py-10 text-5xl text-color-bright-blue"> Privacy Policy</h2>
                        <section className="leading-8 terms-of-policy">
                            ...
                            <p><strong>We use cookies to:</strong></p><ul><li>Help remember and process the items in the shopping cart.</li><li>Understand and save user’s preferences for future visits.</li><li>Keep track of advertisements.</li><li>Compile aggregate data about site traffic and site interactions in order to offer better site experiences and tools in the future. We may also use trusted third-party services that track this information on our behalf.</li></ul>
                            ...
                            <p><strong>We engage in this practice because:</strong></p>
                            ...
                            <p>We have implemented the following:</p><ul><li>Remarketing with Google AdSense</li><li>Google Display Network Impression Reporting</li><li>Demographics and Interests Reporting</li><li>DoubleClick Platform Integration</li></ul>
                            <p>We, along with third-party vendors such as Google use first-party cookies (such as the Google Analytics cookies) and third-party cookies (such as the DoubleClick cookie) or other third-party identifiers together to compile data regarding user interactions with ad impressions and other ad service functions as they relate to our website.</p>
                            <p><strong>Google API</strong></p>
                            <p>If you choose to integrate your google account with Demand we will only use the connection to read and send emails on your behalf. The reading of emails is simply to identify if there is a reply to the email to stop further emails from being sent. Our app uses the following Google API end points https://www.googleapis.com/auth/gmail.compose to send emails on your behalf, https://mail.google.com/ and https://www.googleapis.com/auth/contacts.readonly they are used to read replied to stop followup emails. This is used to ensure you can send emails and we stop email followup upon a reply. Voogy does not read your emails or content, we only scan for the subject and email adress.</p>
                            <p><strong>Google API Additional Limited Usage</strong></p>
                            <p>App’s use of information received, and App’s transfer of information to any other app, from Google APIs will adhere to Google’s Limited Use Requirements.</p>
                            <p><strong>Google Chrome Extensions</strong></p>
                            <p>If you use our Google Chrome extension we are capturing your session cookie which cannot be used to identify you or in anyway is personal identifiable identity..</p>
                            ...
                            <p>You will be notified of any Privacy Policy changes:</p><ul><li>On our Privacy Policy Page</li></ul>
                            <p>Can change your personal information:</p><ul><li>By logging in to your account</li></ul>
                            ...
                            <p>We will notify you via phone call</p><ul><li>Other</li></ul>
                            ...
                            <p>We collect your email address in order to:</p><ul><li>Send information, respond to inquiries, and/or other requests or questions</li><li>Process orders and to send information and updates pertaining to orders.</li><li>Send you additional information related to your product and/or service</li><li>Market to our mailing list or continue to send emails to our clients after the original transaction has occurred.</li></ul>
                            ...
                            <p>If at any time you would like to unsubscribe from receiving future emails, you can email us at</p><ul><li>Follow the instructions at the bottom of each email.</li></ul>
                            <p>and we will promptly remove you from ALL correspondence.</p>
                            <p><strong>Contacting Us</strong></p>
                            <p>If there are any questions regarding this privacy policy, you may contact us using the information below.</p>
                            <p>useDemand LTD<br />71-75 Shelton Street<br />Covent Garden, London WC2H 9JQ<br />United Kingdom<br />info@usedemand.com<br />+1 (650) 741-0510</p>
                        </section>
                    </div>
                </div>
            </main>
